          ...
          */}
          ...
          >
            {CARDS.map((card) => (
              <div
                key={card.title}
                className="flex h-full flex-col gap-3 rounded-xl bg-gray-card p-4 text-brown-dark"
              >
                <p className="whitespace-pre-line font-sans text-sm font-normal leading-5 md:text-base">
                  {card.title}
                </p>
                <p
          ...
          <div className="pointer-events-none absolute left-1/2 top-1/2 z-10 hidden size-[64px] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-[#E0E738] shadow-[0_0_0_3px_rgba(224,231,56,0.18)] sm:flex">
